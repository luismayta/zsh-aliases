<!-- Space: Projects -->
<!-- Parent: ZshAliases -->
<!-- Title: Contributing GithubFlow ZshAliases -->
<!-- Label: ZshAliases -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-aliases project on [GitHub](https://github.com/luismayta/zsh-aliases), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/zsh-aliases/pulls).
...
To follow the instructions in this guide and start contributing to zsh-aliases project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/zsh-aliases.git
```

Now your **upstream** points to **luismayta/zsh-aliases**.
...
git fetch upstream # assuming upstream is luismayta/zsh-aliases
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/zsh-aliases/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
