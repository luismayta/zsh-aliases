...
Contributions to zsh-aliases are welcome.

Feel free to use all of the contribution options:

- Contribute to zsh-aliases repositories on [GitHub](https://github.com/luismayta/zsh-aliases). See [Git flow](./contribute/github-flow.md).
...
Documentation is a part of the zsh-aliases code base. You can find the documentation files in the `doc/` subdirectory of the [main repository](https://github.com/luismayta/zsh-aliases). This means that the contribution process is the same for both the source code and documentation.
...
1.  See if a [Pull Request](https://github.com/luismayta/zsh-aliases/pulls) exists
    - Add some comments or review the code to help it along
    - Don\'t be afraid to comment when logic needs clarification
2.  Create a Fork and open a [Pull Request](https://github.com/luismayta/zsh-aliases/pulls) if needed

### Code Review

- Anyone can review code
- Any [Pull Request](https://github.com/luismayta/zsh-aliases/pulls) should be closed or merged within a week
